...
if ( UNIX )
	...
	list( APPEND ${PROJECT_NAME}_CXX_FLAGS "-Wno-deprecated-enum-enum-conversion" ) # arithmetic between different enumeration types '' and '' is deprecated
	...
	list( APPEND ${PROJECT_NAME}_CXX_FLAGS_RELEASE "--param inline-unit-growth=75" ) # default ( 50 )
