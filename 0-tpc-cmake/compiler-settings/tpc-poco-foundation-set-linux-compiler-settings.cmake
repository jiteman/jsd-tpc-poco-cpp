...
if ( UNIX )
	...
	list( APPEND ${PROJECT_NAME}_C_FLAGS "-Wno-old-style-definition" ) # old-style function definition
	...
	list( APPEND ${PROJECT_NAME}_C_FLAGS "-Wno-unknown-pragmas" ) # ignoring "#pragma ..."
	...
	list( APPEND ${PROJECT_NAME}_CXX_FLAGS "-Wno-volatile" ) # "" expression of "volatile"-qualified type is deprecated
